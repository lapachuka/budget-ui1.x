(function () {
    ...
    LineChart.$inject = ["$http", "CONSTANT"];
    angular
        .module('line-chart')
        .factory('LineChart', LineChart);

    /* @ngInject */
    function LineChart($http, CONSTANT) {
        var chartData = {
                data: [[0], [0]],
                series: [],
        ...
        function getData(data, type) {
            ...
            $http.get(CONSTANT.BASE_URL +'/statistics/by-year?year=' + currentYear + '&type=' + type + "&currency=" + currentCurrency)
