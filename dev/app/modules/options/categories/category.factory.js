(function () {
    ...
    CategoryModel.$inject = ["$http", "$q", "CONSTANT"];
    angular
        .module('categoryModule')
        .factory('Category', CategoryModel);

    /* @ngInject */
    function CategoryModel($http, $q, CONSTANT) {
        var categoryList = {
                income: [],
                expenses: []
            },
        ...
        function setCategoryUrl() {
            categoryUrl = CONSTANT.BASE_URL +'/categories?type=' + categoryType;
        }
        ...
        function fillListData(data) {
            ...
            categoryList[categoryType].sort(function(a, b) {
                if (a.name < b.name)
                    return -1;
        ...
        function remove(index, childIndex) {
            ...
            $http.delete(CONSTANT.BASE_URL +'/categories' + '\\' + id + '?type=' + categoryType)
                .success(function () {
