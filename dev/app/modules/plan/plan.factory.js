    ...
    function Plan($http, $q) {
        ...
        function getCompareList(currencyId, type, filterDate) {
            if (valid(currencyId, type)) {
                ...
                $http.get(CONSTANT.BASE_URL + '/plan/compare?currency=' + currencyId + '&type=' + type + '&year=' + filterDate.year + '&month=' + filterDate.month)
        ...
        function getList(currencyId, type) {
            if (valid(currencyId, type)) {
                ...
                $http.get(CONSTANT.BASE_URL + '/plan?currency=' + currencyId + '&type=' + type)
                    .then(function (response) {
        ...
        function update(planList, currencyId) {
            var planDataForUpdate = prepareDataForUpdate(planList),
                deferred = $q.defer(),
                url = CONSTANT.BASE_URL + '/plan?currency=' + currencyId;
